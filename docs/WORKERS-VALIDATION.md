...
- Wrangler bundled the Worker: 2109.14 KiB uncompressed and 605,044 bytes gzipped. The integration test enforces a conservative project budget of 3 MiB gzipped, not Cloudflare's current platform limit. Cloudflare currently documents a 64 MiB uncompressed limit and no compressed limit. The bundle excludes `node:sqlite`.
...
Current platform limits: https://developers.cloudflare.com/workers/platform/limits/#worker-size
